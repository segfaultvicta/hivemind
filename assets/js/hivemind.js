...
var _segfaultvicta$hivemind$Hivemind$intToPercentageString = function (pct) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(pct),
		'%');
};
var _segfaultvicta$hivemind$Hivemind$selectionStatus = F2(
	function (model, sentiment) {
		return _elm_lang$core$Native_Utils.eq(model.user_sentiment, sentiment) ? ' sentiment-selected' : ' sentiment-unselected';
	});
var _segfaultvicta$hivemind$Hivemind$renderExplanatoryText = {
	ctor: '::',
	_0: A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('explanatory'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('fas fa-2x fa-question-circle'),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Question - need more information, or need information to be stated more clearly.'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fas fa-2x fa-exclamation-triangle'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('Point of Order - the conversation has strayed from its topic.'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fas fa-2x fa-hand-paper'),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('Raised Hand - you have a response or wish to add to the conversation.'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fas fa-2x fa-thumbs-down'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Hard Block - you have a severe consensus-blocking issue with something.'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _segfaultvicta$hivemind$Hivemind$renderBlockingSentiment = function (block) {
	var blocking_text = function () {
		var _p0 = block.sentiment;
		switch (_p0) {
			case 'question':
				return ' needs more information.';
			case 'poo':
				return ' wants the conversation to get back on track.';
			case 'raisedhand':
				return ' wants a chance to speak.';
			case 'hardno':
				return ' has a serious problem.';
			default:
				return '';
		}
	}();
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('blocking-sentiment'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], block.username, blocking_text)),
			_1: {ctor: '[]'}
		});
};
var _segfaultvicta$hivemind$Hivemind$renderBlockingSentiments = function (blocks) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$ul,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, _segfaultvicta$hivemind$Hivemind$renderBlockingSentiment, blocks)),
		_1: {ctor: '[]'}
	};
};
var _segfaultvicta$hivemind$Hivemind$renderSentimentTracker = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$div,
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('progress-bar progress-bar-striped progress-bar-animated bg-info'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'width',
										_1: _segfaultvicta$hivemind$Hivemind$intToPercentageString(model.happy)
									},
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_segfaultvicta$hivemind$Hivemind$intToPercentageString(model.happy)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('progress-bar bg-warning'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'width',
											_1: _segfaultvicta$hivemind$Hivemind$intToPercentageString(model.neutral)
										},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_segfaultvicta$hivemind$Hivemind$intToPercentageString(model.neutral)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('progress-bar progress-bar-striped progress-bar-animated bg-danger'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(
										{
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'width',
												_1: _segfaultvicta$hivemind$Hivemind$intToPercentageString(model.sad)
											},
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_segfaultvicta$hivemind$Hivemind$intToPercentageString(model.sad)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _segfaultvicta$hivemind$Hivemind$roundDownToSecond = function (ms) {
...
var _segfaultvicta$hivemind$Hivemind$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {loc: a, connectionStatus: b, currentTime: c, phone: d, socketUrl: e, username: f, user_sentiment: g, happy: h, neutral: i, sad: j, blocks: k};
										};
									};
								};
							};
...
var _segfaultvicta$hivemind$Hivemind$Block = F2(
	function (a, b) {
		return {username: a, sentiment: b};
	});
var _segfaultvicta$hivemind$Hivemind$blockDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (username, sentiment) {
			return A2(_segfaultvicta$hivemind$Hivemind$Block, username, sentiment);
		}),
	A2(_elm_lang$core$Json_Decode$field, 'username', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'sentiment', _elm_lang$core$Json_Decode$string));
var _segfaultvicta$hivemind$Hivemind$blocksDecoder = _elm_lang$core$Json_Decode$list(_segfaultvicta$hivemind$Hivemind$blockDecoder);
var _segfaultvicta$hivemind$Hivemind$InitFlags = F3(
	function (a, b, c) {
		return {loc: a, width: b, socketUrl: c};
	});
var _segfaultvicta$hivemind$Hivemind$UpdatePayloadContainer = F5(
	function (a, b, c, d, e) {
		return {name: a, happy: b, neutral: c, sad: d, blocks: e};
	});
var _segfaultvicta$hivemind$Hivemind$updateDecoder = A6(
	_elm_lang$core$Json_Decode$map5,
	F5(
		function (name, happy, neutral, sad, blocks) {
			return A5(_segfaultvicta$hivemind$Hivemind$UpdatePayloadContainer, name, happy, neutral, sad, blocks);
		}),
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'happy', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'neutral', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'sad', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'blocks', _segfaultvicta$hivemind$Hivemind$blocksDecoder));
var _segfaultvicta$hivemind$Hivemind$SentimentSelectedContainer = function (a) {
	return {new_sentiment: a};
};
var _segfaultvicta$hivemind$Hivemind$sentimentSelectedDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	function (new_sentiment) {
		return _segfaultvicta$hivemind$Hivemind$SentimentSelectedContainer(new_sentiment);
	},
	A2(_elm_lang$core$Json_Decode$field, 'new_sentiment', _elm_lang$core$Json_Decode$string));
var _segfaultvicta$hivemind$Hivemind$ScheduledReconnect = function (a) {
	return {ctor: 'ScheduledReconnect', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$Disconnected = {ctor: 'Disconnected'};
var _segfaultvicta$hivemind$Hivemind$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			loc: flags.loc,
			connectionStatus: _segfaultvicta$hivemind$Hivemind$Disconnected,
			currentTime: 0,
...
var _segfaultvicta$hivemind$Hivemind$Connected = {ctor: 'Connected'};
var _segfaultvicta$hivemind$Hivemind$SentimentSelected = function (a) {
	return {ctor: 'SentimentSelected', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'SocketClosedAbnormally':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							connectionStatus: _segfaultvicta$hivemind$Hivemind$ScheduledReconnect(
								{
									time: _segfaultvicta$hivemind$Hivemind$roundDownToSecond(model.currentTime + _p1._0.reconnectWait)
								})
						}),
					{ctor: '[]'});
			...
			case 'InitChannel':
				var _p5 = _p1._0;
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$hivemind$Hivemind$updateDecoder, _p5);
				if (_p2.ctor === 'Ok') {
					var _p3 = _p2._0;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{username: _p3.name, happy: _p3.happy, neutral: _p3.neutral, sad: _p3.sad, blocks: _p3.blocks}),
						{ctor: '[]'});
				} else {
					var _p4 = A2(
						_elm_lang$core$Debug$log,
						'initChannel payload error: ',
						{ctor: '_Tuple2', _0: _p2._0, _1: _p5});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
			...
			case 'HiveUpdate':
				var _p9 = _p1._0;
				var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$hivemind$Hivemind$updateDecoder, _p9);
				if (_p6.ctor === 'Ok') {
					var _p7 = _p6._0;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{happy: _p7.happy, neutral: _p7.neutral, sad: _p7.sad, blocks: _p7.blocks}),
						{ctor: '[]'});
				} else {
					var _p8 = A2(
						_elm_lang$core$Debug$log,
						'hiveUpdate payload error: ',
						{ctor: '_Tuple2', _0: _p6._0, _1: _p9});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
			...
			case 'SelectSentiment':
				var push = A2(
					...
					function (response) {
						return _segfaultvicta$hivemind$Hivemind$SentimentSelected(response);
					},
					A2(
			...
			default:
				var _p12 = _p1._0;
				var _p10 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$hivemind$Hivemind$sentimentSelectedDecoder, _p12);
				if (_p10.ctor === 'Ok') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{user_sentiment: _p10._0.new_sentiment}),
						{ctor: '[]'});
				} else {
					var _p11 = A2(
						_elm_lang$core$Debug$log,
						'sentimentSelected payload error: ',
						{ctor: '_Tuple2', _0: _p10._0, _1: _p12});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
...
var _segfaultvicta$hivemind$Hivemind$HiveUpdate = function (a) {
	return {ctor: 'HiveUpdate', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$SelectSentiment = function (a) {
	return {ctor: 'SelectSentiment', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$renderSentimentSelection = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('row d-flex justify-content-center temperature-sentiments'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$class(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'sentiment-icon temperature-happy',
								A2(_segfaultvicta$hivemind$Hivemind$selectionStatus, model, 'happy'))),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-smile'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_segfaultvicta$hivemind$Hivemind$SelectSentiment('happy')),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _elm_lang$html$Html_Attributes$class(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'sentiment-icon temperature-neutral',
									A2(_segfaultvicta$hivemind$Hivemind$selectionStatus, model, 'neutral'))),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-meh'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_segfaultvicta$hivemind$Hivemind$SelectSentiment('neutral')),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _elm_lang$html$Html_Attributes$class(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'sentiment-icon temperature-sad',
										A2(_segfaultvicta$hivemind$Hivemind$selectionStatus, model, 'sad'))),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-frown'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_segfaultvicta$hivemind$Hivemind$SelectSentiment('sad')),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('row d-flex justify-content-center blocker-sentiments'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _elm_lang$html$Html_Attributes$class(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'sentiment-icon blocker-question',
									A2(_segfaultvicta$hivemind$Hivemind$selectionStatus, model, 'question'))),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-question-circle'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_segfaultvicta$hivemind$Hivemind$SelectSentiment('question')),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _elm_lang$html$Html_Attributes$class(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'sentiment-icon blocker-poo',
										A2(_segfaultvicta$hivemind$Hivemind$selectionStatus, model, 'poo'))),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-exclamation-triangle'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_segfaultvicta$hivemind$Hivemind$SelectSentiment('poo')),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{
									...
									_0: _elm_lang$html$Html_Attributes$class(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'sentiment-icon blocker-raisedhand',
											A2(_segfaultvicta$hivemind$Hivemind$selectionStatus, model, 'raisedhand'))),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-hand-paper'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_segfaultvicta$hivemind$Hivemind$SelectSentiment('raisedhand')),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
								...
								_0: A2(
									_elm_lang$html$Html$div,
									{
										...
										_0: _elm_lang$html$Html_Attributes$class(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'sentiment-icon blocker-hardno',
												A2(_segfaultvicta$hivemind$Hivemind$selectionStatus, model, 'hardno'))),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-thumbs-down'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_segfaultvicta$hivemind$Hivemind$SelectSentiment('hardno')),
													_1: {ctor: '[]'}
												}
											},
											{ctor: '[]'}),
...
var _segfaultvicta$hivemind$Hivemind$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('hivemind-interface'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('navbar navbar-expand room-name'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('container d-flex justify-content-center'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										model.username,
										A2(_elm_lang$core$Basics_ops['++'], ' in ', model.loc)))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('container-fluid sentiment-tracking'),
						_1: {ctor: '[]'}
					},
					_segfaultvicta$hivemind$Hivemind$renderSentimentTracker(model)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('container d-flex justify-content-center blocking-sentiments'),
							_1: {ctor: '[]'}
						},
						_segfaultvicta$hivemind$Hivemind$renderBlockingSentiments(model.blocks)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('container sentiment-select'),
								_1: {ctor: '[]'}
							},
							_segfaultvicta$hivemind$Hivemind$renderSentimentSelection(model)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('container d-flex justify-content-center explanations'),
									_1: {ctor: '[]'}
								},
								_segfaultvicta$hivemind$Hivemind$renderExplanatoryText),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _segfaultvicta$hivemind$Hivemind$InitChannel = function (a) {
	return {ctor: 'InitChannel', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$connect = function (model) {
	return _saschatimme$elm_phoenix$Phoenix_Channel$withDebug(
		A3(
			_saschatimme$elm_phoenix$Phoenix_Channel$on,
			'hive_update',
			function (msg) {
				return _segfaultvicta$hivemind$Hivemind$HiveUpdate(msg);
			},
			A2(
				_saschatimme$elm_phoenix$Phoenix_Channel$onJoin,
				_segfaultvicta$hivemind$Hivemind$InitChannel,
				_saschatimme$elm_phoenix$Phoenix_Channel$init(
					A2(_elm_lang$core$Basics_ops['++'], 'room:', model.loc)))));
};
var _segfaultvicta$hivemind$Hivemind$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$ConnectionStatusChanged = function (a) {
	return {ctor: 'ConnectionStatusChanged', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$SocketClosedAbnormally = function (a) {
	return {ctor: 'SocketClosedAbnormally', _0: a};
};
var _segfaultvicta$hivemind$Hivemind$socket = function (model) {
	return A2(
		...
		A2(
			...
			_segfaultvicta$hivemind$Hivemind$SocketClosedAbnormally,
			A2(
				_saschatimme$elm_phoenix$Phoenix_Socket$onClose,
				function (_p13) {
					return _segfaultvicta$hivemind$Hivemind$ConnectionStatusChanged(_segfaultvicta$hivemind$Hivemind$Disconnected);
				},
				A2(
					_saschatimme$elm_phoenix$Phoenix_Socket$onOpen,
					_segfaultvicta$hivemind$Hivemind$ConnectionStatusChanged(_segfaultvicta$hivemind$Hivemind$Connected),
					_saschatimme$elm_phoenix$Phoenix_Socket$init(model.socketUrl)))));
};
var _segfaultvicta$hivemind$Hivemind$phoenixSubscription = function (model) {
	return A2(
		_saschatimme$elm_phoenix$Phoenix$connect,
		_segfaultvicta$hivemind$Hivemind$socket(model),
		{
			ctor: '::',
			_0: _segfaultvicta$hivemind$Hivemind$connect(model),
			_1: {ctor: '[]'}
		});
};
var _segfaultvicta$hivemind$Hivemind$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _segfaultvicta$hivemind$Hivemind$phoenixSubscription(model),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _segfaultvicta$hivemind$Hivemind$Tick),
				_1: {ctor: '[]'}
			}
		});
};
var _segfaultvicta$hivemind$Hivemind$main = _elm_lang$html$Html$programWithFlags(
	{init: _segfaultvicta$hivemind$Hivemind$init, view: _segfaultvicta$hivemind$Hivemind$view, subscriptions: _segfaultvicta$hivemind$Hivemind$subscriptions, update: _segfaultvicta$hivemind$Hivemind$update})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (loc) {
			return A2(
				...
				function (socketUrl) {
					return A2(
						...
						function (width) {
							return _elm_lang$core$Json_Decode$succeed(
								{loc: loc, socketUrl: socketUrl, width: width});
						},
...
var Elm = {};
Elm['Hivemind'] = Elm['Hivemind'] || {};
if (typeof _segfaultvicta$hivemind$Hivemind$main !== 'undefined') {
    _segfaultvicta$hivemind$Hivemind$main(Elm['Hivemind'], 'Hivemind', {"types":{"unions":{"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Hivemind.Msg":{"args":[],"tags":{"Tick":["Time.Time"],"HiveUpdate":["Json.Decode.Value"],"InitChannel":["Json.Decode.Value"],"SelectSentiment":["String"],"SocketClosedAbnormally":["Phoenix.Socket.AbnormalClose"],"ConnectionStatusChanged":["Hivemind.ConnectionStatus"],"SentimentSelected":["Json.Decode.Value"]}},"Hivemind.ConnectionStatus":{"args":[],"tags":{"Connected":[],"Disconnected":[],"ScheduledReconnect":["{ time : Time.Time }"]}}},"aliases":{"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Time.Time":{"args":[],"type":"Float"},"Phoenix.Socket.AbnormalClose":{"args":[],"type":"{ reconnectAttempt : Int, reconnectWait : Time.Time }"}},"message":"Hivemind.Msg"},"versions":{"elm":"0.18.0"}});
}
